...
CREATE TABLE characters (
    ...
    role VARCHAR(50) NOT NULL CHECK (role IN ('Playable Character', 'Boss', 'NPC', 'Boss/NPC', 'Merchant', 'Wanderer', 'Quest NPC', 'Pilgrim'))
);
...
CREATE TABLE bosses (
    ...
    difficulty VARCHAR(20) NOT NULL CHECK (difficulty IN ('Easy', 'Medium', 'Hard', 'Very Hard', 'Extreme')),
...
-- FRENCH VERSION
(23, 'Moss Mother', 'Gardienne de la Grotte de Mousse', 'Le premier boss affronté par Hornet. Une grande créature volante qui émerge d’un cocon végétal. Elle plane et vole autour de l’arène, utilisant son dard et des attaques basées sur la nature pour défendre son domaine.', 'Grotte de Mousse - Chapelle en Ruine', 'Facile', '["Swoop", "Stinger Dive", "Spore Cloud", "Aerial Charge"]', 'moss-mother', '["Compétence Lien", "Bobine de Soie"]', 'fr'),
(24, 'Lace', 'L’Escrimeuse Sadique', 'Une escrimeuse cruelle et mortelle maniant une épingle dorée avec grâce et précision. Elle prend plaisir au combat et nourrit un désir ardent d’éliminer Hornet, testant ses compétences lors de multiples affrontements à travers Pharloom.', 'Multiples Lieux', 'Difficile', '["Pin Thrust", "Spinning Slash", "Dash Strike", "Aerial Pierce", "Counter Stance"]', 'lace', '["Grâce de la Tisseuse", "Bobine de Soie", "Chapelets"]', 'fr'),
(25, 'Shrine Guardian Seth', 'Protecteur Éternel', 'Un ancien gardien choisi par la Voix, qui attend parmi les racines emmêlées à la base de la Citadelle. Imprégné d’une force et d’une endurance hors du commun, il protège un secret depuis longtemps oublié.', 'La Citadelle', 'Moyen', '["Root Slam", "Ground Pound", "Shockwave", "Bramble Barrier"]', 'seth', '["Sceau Ancien", "Bobine de Soie"]', 'fr'),
(26, 'Shakra', 'La Cartographe Guerrière', 'Une fière combattante ayant maîtrisé à la fois l’art du combat et celui de la cartographie. Elle manie des anneaux tranchants avec une précision mortelle tout en cherchant son maître disparu à travers Pharloom.', 'Docks Profonds', 'Moyen', '["Ring Toss", "Multi-Ring Barrage", "Spinning Ring Shield", "Bouncing Rings"]', 'shakra', '["Fragment de Carte", "Bobine de Soie", "Chapelets"]', 'fr'),
(27, 'Skarrsinger Karmelita', 'La Cantatrice Monstrueuse', 'Une gigantesque et terrifiante créature utilisant des attaques basées sur le son. Ses chants hantés et ses frappes puissantes en font l’une des confrontations les plus redoutables de Pharloom.', 'Lieu Inconnu', 'Très Difficile', '["Sonic Scream", "Sound Wave", "Crushing Slam", "Echo Strike"]', 'karmelita', '["Compétence Cloche", "Bobine de Soie", "Objet Spécial"]', 'fr'),
(28, 'Skull Tyrant', 'Seigneur de la Moelle', 'Une cible de Grande Chasse trouvée dans la Moelle. Hornet doit traquer et éliminer ce tyran squelettique qui terrorise les profondeurs remplies d’os.', 'La Moelle', 'Difficile', '["Bone Throw", "Skull Smash", "Skeletal Summon", "Death Charge"]', 'skull-tyrant', '["Charme d’Os", "Bobine de Soie", "Récompense de Chasse"]', 'fr'),
(29, 'Moorwing', 'Terreur des Landes', 'Une bête volante qui patrouille les landes avec des attaques aériennes féroces. Ses mouvements rapides et imprévisibles en font un adversaire redoutable.', 'Landes', 'Moyen', '["Aerial Dive", "Wing Gust", "Swooping Strike", "Feather Barrage"]', 'moorwing', '["Plume Talisman", "Bobine de Soie"]', 'fr'),
(30, 'Nyleth', 'Titre Inconnu', 'Un boss mystérieux de Hollow Knight: Silksong, proposant des mécaniques uniques et des attaques difficiles à anticiper.', 'Lieu Inconnu', 'Moyen', '["Unknown Attack 1", "Unknown Attack 2", "Unknown Attack 3", "Unknown Attack 4"]', 'nyleth', '["Récompense Inconnue", "Bobine de Soie"]', 'fr'),
(31, 'Palestag', 'Le Guerrier Pâle', 'Un guerrier redoutable à la peau pâle, connu pour ses techniques de combat rapides et précises. Maître du corps à corps et expert en défense.', 'Lieu Inconnu', 'Difficile', '["Pale Slash", "Shield Bash", "Charging Strike", "Defensive Stance"]', 'palestag', '["Insigne du Guerrier", "Bobine de Soie"]', 'fr'),
(32, 'Second Sentinel', 'Le Veilleur', 'Un gardien qui protège des zones clés de Pharloom. Fait partie d’une série de sentinelles rencontrées tout au long du royaume.', 'Lieu Inconnu', 'Moyen', '["Sentinel Strike", "Guard Stance", "Sweeping Attack", "Defensive Pulse"]', 'second-sentinel', '["Clé de Sentinelle", "Bobine de Soie"]', 'fr');
